...
import dev.sismed.scheduling.service.handler.ManipuladorRequisicaoAgendamento;
import io.grpc.stub.StreamObserver;
import net.devh.boot.grpc.server.service.GrpcService;

@GrpcService
public class ServicoAgendamento extends ServicoAgendamentoImplBase {

    private final ManipuladorRequisicaoAgendamento manipulador;

    public ServicoAgendamento(ManipuladorRequisicaoAgendamento manipulador) {
